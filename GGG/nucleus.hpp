...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//  by Thomas Sokolowski, Thorsten Erdmann
...
class nucleus
{
    ...
    private:
        ...
        static const double ARTIFICIAL_INFINITY = 1.0e+300;    // was DBL_MAX before, but this sometimes causes problems at temporary outputs!        
