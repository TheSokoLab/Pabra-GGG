...
{
    //Check, whether the array is already there! Otherwise kill. TODO
...
{
    //Check if nucleus is initialized
...
{	//Check if propensities are there and times are calculated! Otherwise terminate.
