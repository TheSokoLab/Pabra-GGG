//  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//  r u n _ p a r a m e t e r . c p p
//  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
int run_parameter::read_filenames(int argc, char *argv[])
{
    ...
    in_file >> bnd_tra_file;
    in_file >> bnd_dst_file;
    in_file >> average_file;
    in_file >> density_file;
    in_file >> bcd_hbk_file;
    in_file >> ranvar_file;
...
int run_parameter::write_header(ofstream & fout,const char * filename)
{
    ...
    fout << "# * Output.............: " << traject_file << endl;
    fout << "# * ...................: " << bnd_tra_file << endl;
    fout << "# * ...................: " << bnd_dst_file << endl;
    fout << "# * ...................: " << average_file << endl;
    fout << "# * ...................: " << density_file << endl;
    fout << "# * ...................: " << bcd_hbk_file << endl;
    fout << "# * * * * * * * * * * * * * ** * * * * * * * * *" << endl << endl;
    ...
    fout << "# * max_outputs.....: "<< max_outputs << endl;
    ...
    fout << "# * max. rows.......: "<< max_rows   << endl;
    fout << "# * max. columns....: "<< max_cols   << endl;
